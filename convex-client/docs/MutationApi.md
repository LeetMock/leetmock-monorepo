...
[**api_run_coding_question_set_add_question_to_coding_question_set_post**](MutationApi.md#api_run_coding_question_set_add_question_to_coding_question_set_post) | **POST** /api/run/codingQuestionSet/addQuestionToCodingQuestionSet | Calls a mutation at the path codingQuestionSet.js:addQuestionToCodingQuestionSet
[**api_run_coding_question_set_create_coding_question_set_post**](MutationApi.md#api_run_coding_question_set_create_coding_question_set_post) | **POST** /api/run/codingQuestionSet/createCodingQuestionSet | Calls a mutation at the path codingQuestionSet.js:createCodingQuestionSet
[**api_run_coding_question_set_remove_question_from_coding_question_set_post**](MutationApi.md#api_run_coding_question_set_remove_question_from_coding_question_set_post) | **POST** /api/run/codingQuestionSet/removeQuestionFromCodingQuestionSet | Calls a mutation at the path codingQuestionSet.js:removeQuestionFromCodingQuestionSet
...
# **api_run_coding_question_set_add_question_to_coding_question_set_post**
> ResponseCodingQuestionSetAddQuestionToCodingQuestionSet api_run_coding_question_set_add_question_to_coding_question_set_post(request_coding_question_set_add_question_to_coding_question_set)
...
with convex_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = convex_client.MutationApi(api_client)
    request_coding_question_set_add_question_to_coding_question_set = convex_client.RequestCodingQuestionSetAddQuestionToCodingQuestionSet() # RequestCodingQuestionSetAddQuestionToCodingQuestionSet | 

    try:
        # Calls a mutation at the path codingQuestionSet.js:addQuestionToCodingQuestionSet
        api_response = api_instance.api_run_coding_question_set_add_question_to_coding_question_set_post(request_coding_question_set_add_question_to_coding_question_set)
        print("The response of MutationApi->api_run_coding_question_set_add_question_to_coding_question_set_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MutationApi->api_run_coding_question_set_add_question_to_coding_question_set_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_coding_question_set_add_question_to_coding_question_set** | [**RequestCodingQuestionSetAddQuestionToCodingQuestionSet**](RequestCodingQuestionSetAddQuestionToCodingQuestionSet.md)|  | 

### Return type

[**ResponseCodingQuestionSetAddQuestionToCodingQuestionSet**](ResponseCodingQuestionSetAddQuestionToCodingQuestionSet.md)
...
# **api_run_coding_question_set_create_coding_question_set_post**
> ResponseCodingQuestionSetCreateCodingQuestionSet api_run_coding_question_set_create_coding_question_set_post(request_coding_question_set_create_coding_question_set)
...
with convex_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = convex_client.MutationApi(api_client)
    request_coding_question_set_create_coding_question_set = convex_client.RequestCodingQuestionSetCreateCodingQuestionSet() # RequestCodingQuestionSetCreateCodingQuestionSet | 

    try:
        # Calls a mutation at the path codingQuestionSet.js:createCodingQuestionSet
        api_response = api_instance.api_run_coding_question_set_create_coding_question_set_post(request_coding_question_set_create_coding_question_set)
        print("The response of MutationApi->api_run_coding_question_set_create_coding_question_set_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MutationApi->api_run_coding_question_set_create_coding_question_set_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_coding_question_set_create_coding_question_set** | [**RequestCodingQuestionSetCreateCodingQuestionSet**](RequestCodingQuestionSetCreateCodingQuestionSet.md)|  | 

### Return type

[**ResponseCodingQuestionSetCreateCodingQuestionSet**](ResponseCodingQuestionSetCreateCodingQuestionSet.md)
...
# **api_run_coding_question_set_remove_question_from_coding_question_set_post**
> ResponseCodingQuestionSetRemoveQuestionFromCodingQuestionSet api_run_coding_question_set_remove_question_from_coding_question_set_post(request_coding_question_set_remove_question_from_coding_question_set)
...
with convex_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = convex_client.MutationApi(api_client)
    request_coding_question_set_remove_question_from_coding_question_set = convex_client.RequestCodingQuestionSetRemoveQuestionFromCodingQuestionSet() # RequestCodingQuestionSetRemoveQuestionFromCodingQuestionSet | 

    try:
        # Calls a mutation at the path codingQuestionSet.js:removeQuestionFromCodingQuestionSet
        api_response = api_instance.api_run_coding_question_set_remove_question_from_coding_question_set_post(request_coding_question_set_remove_question_from_coding_question_set)
        print("The response of MutationApi->api_run_coding_question_set_remove_question_from_coding_question_set_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MutationApi->api_run_coding_question_set_remove_question_from_coding_question_set_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_coding_question_set_remove_question_from_coding_question_set** | [**RequestCodingQuestionSetRemoveQuestionFromCodingQuestionSet**](RequestCodingQuestionSetRemoveQuestionFromCodingQuestionSet.md)|  | 

### Return type

[**ResponseCodingQuestionSetRemoveQuestionFromCodingQuestionSet**](ResponseCodingQuestionSetRemoveQuestionFromCodingQuestionSet.md)
