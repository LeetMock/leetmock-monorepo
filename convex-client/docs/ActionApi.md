...
[**api_run_actions_get_editor_snapshot_post**](ActionApi.md#api_run_actions_get_editor_snapshot_post) | **POST** /api/run/actions/getEditorSnapshot | Calls a action at the path actions.js:getEditorSnapshot
...
[**api_run_code_runner_run_code_post**](ActionApi.md#api_run_code_runner_run_code_post) | **POST** /api/run/codeRunner/runCode | Calls a action at the path codeRunner.js:runCode
[**api_run_code_runner_run_tests_post**](ActionApi.md#api_run_code_runner_run_tests_post) | **POST** /api/run/codeRunner/runTests | Calls a action at the path codeRunner.js:runTests
...
# **api_run_actions_get_editor_snapshot_post**
> ResponseActionsGetEditorSnapshot api_run_actions_get_editor_snapshot_post(request_actions_get_editor_snapshot)
...
with convex_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = convex_client.ActionApi(api_client)
    request_actions_get_editor_snapshot = convex_client.RequestActionsGetEditorSnapshot() # RequestActionsGetEditorSnapshot | 

    try:
        # Calls a action at the path actions.js:getEditorSnapshot
        api_response = api_instance.api_run_actions_get_editor_snapshot_post(request_actions_get_editor_snapshot)
        print("The response of ActionApi->api_run_actions_get_editor_snapshot_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActionApi->api_run_actions_get_editor_snapshot_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_actions_get_editor_snapshot** | [**RequestActionsGetEditorSnapshot**](RequestActionsGetEditorSnapshot.md)|  | 

### Return type

[**ResponseActionsGetEditorSnapshot**](ResponseActionsGetEditorSnapshot.md)
...
# **api_run_code_runner_run_code_post**
> ResponseCodeRunnerRunCode api_run_code_runner_run_code_post(request_code_runner_run_code)
...
with convex_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = convex_client.ActionApi(api_client)
    request_code_runner_run_code = convex_client.RequestCodeRunnerRunCode() # RequestCodeRunnerRunCode | 

    try:
        # Calls a action at the path codeRunner.js:runCode
        api_response = api_instance.api_run_code_runner_run_code_post(request_code_runner_run_code)
        print("The response of ActionApi->api_run_code_runner_run_code_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActionApi->api_run_code_runner_run_code_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_code_runner_run_code** | [**RequestCodeRunnerRunCode**](RequestCodeRunnerRunCode.md)|  | 

### Return type

[**ResponseCodeRunnerRunCode**](ResponseCodeRunnerRunCode.md)
...
# **api_run_code_runner_run_tests_post**
> ResponseCodeRunnerRunTests api_run_code_runner_run_tests_post(request_code_runner_run_tests)
...
with convex_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = convex_client.ActionApi(api_client)
    request_code_runner_run_tests = convex_client.RequestCodeRunnerRunTests() # RequestCodeRunnerRunTests | 

    try:
        # Calls a action at the path codeRunner.js:runTests
        api_response = api_instance.api_run_code_runner_run_tests_post(request_code_runner_run_tests)
        print("The response of ActionApi->api_run_code_runner_run_tests_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActionApi->api_run_code_runner_run_tests_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request_code_runner_run_tests** | [**RequestCodeRunnerRunTests**](RequestCodeRunnerRunTests.md)|  | 

### Return type

[**ResponseCodeRunnerRunTests**](ResponseCodeRunnerRunTests.md)
