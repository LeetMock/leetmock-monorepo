...
class TestResponseCodeSessionEventsGetLatestTestcaseChangeEvent(unittest.TestCase):
    """ResponseCodeSessionEventsGetLatestTestcaseChangeEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseCodeSessionEventsGetLatestTestcaseChangeEvent:
        """Test ResponseCodeSessionEventsGetLatestTestcaseChangeEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseCodeSessionEventsGetLatestTestcaseChangeEvent`
        """
        model = ResponseCodeSessionEventsGetLatestTestcaseChangeEvent()
        if include_optional:
            return ResponseCodeSessionEventsGetLatestTestcaseChangeEvent(
                status = 'success',
                error_message = '',
                error_data = None,
                value = convex_client.models.response_code_session_events_get_latest_testcase_change_event_value.Response_codeSessionEvents_getLatestTestcaseChangeEvent_value(
    ...
    def testResponseCodeSessionEventsGetLatestTestcaseChangeEvent(self):
        """Test ResponseCodeSessionEventsGetLatestTestcaseChangeEvent"""
