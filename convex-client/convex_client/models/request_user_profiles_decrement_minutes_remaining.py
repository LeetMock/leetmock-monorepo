...
class RequestUserProfilesDecrementMinutesRemaining(BaseModel):
    """
    RequestUserProfilesDecrementMinutesRemaining
    """ # noqa: E501
    args: RequestUserProfilesDecrementMinutesRemainingArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestUserProfilesDecrementMinutesRemainingArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
