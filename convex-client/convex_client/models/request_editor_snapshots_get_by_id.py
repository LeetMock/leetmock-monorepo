...
class RequestEditorSnapshotsGetById(BaseModel):
    """
    RequestEditorSnapshotsGetById
    """ # noqa: E501
    args: RequestEditorSnapshotsGetByIdArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestEditorSnapshotsGetByIdArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
