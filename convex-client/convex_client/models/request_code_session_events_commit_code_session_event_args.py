...
class RequestCodeSessionEventsCommitCodeSessionEventArgs(BaseModel):
    """
    RequestCodeSessionEventsCommitCodeSessionEventArgs
    """ # noqa: E501
    event: RequestCodeSessionEventsCommitCodeSessionEventArgsEvent
    session_id: StrictStr = Field(description="ID from table \"sessions\"", alias="sessionId")
    __properties: ClassVar[List[str]] = ["event", "sessionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": RequestCodeSessionEventsCommitCodeSessionEventArgsEvent.from_dict(obj["event"]) if obj.get("event") is not None else None,
