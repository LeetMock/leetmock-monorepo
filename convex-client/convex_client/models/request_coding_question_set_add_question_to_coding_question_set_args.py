...
class RequestCodingQuestionSetAddQuestionToCodingQuestionSetArgs(BaseModel):
    """
    RequestCodingQuestionSetAddQuestionToCodingQuestionSetArgs
    """ # noqa: E501
    coding_question_set_name: StrictStr = Field(alias="codingQuestionSetName")
    question_id: StrictStr = Field(description="ID from table \"questions\"", alias="questionId")
    __properties: ClassVar[List[str]] = ["codingQuestionSetName", "questionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "codingQuestionSetName": obj.get("codingQuestionSetName"),
