...
class RequestActionsGenerateSolutionArgs(BaseModel):
    """
    ...
    language: StrictStr
    output_type: StrictStr = Field(alias="outputType")
    question_content: StrictStr = Field(alias="questionContent")
    question_title: StrictStr = Field(alias="questionTitle")
    __properties: ClassVar[List[str]] = ["functionName", "inputParameters", "language", "outputType", "questionContent", "questionTitle"]
