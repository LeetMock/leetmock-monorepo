...
class RequestActionsGenerateQuestion(BaseModel):
    """
    RequestActionsGenerateQuestion
    """ # noqa: E501
    args: RequestActionsGenerateQuestionArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestActionsGenerateQuestionArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
