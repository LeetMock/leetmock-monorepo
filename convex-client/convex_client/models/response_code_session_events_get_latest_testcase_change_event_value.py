...
class ResponseCodeSessionEventsGetLatestTestcaseChangeEventValue(BaseModel):
    """
    ResponseCodeSessionEventsGetLatestTestcaseChangeEventValue
    """ # noqa: E501
    event: RequestCodeSessionEventsCommitCodeSessionEventArgsEventOneOf3
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": RequestCodeSessionEventsCommitCodeSessionEventArgsEventOneOf3.from_dict(obj["event"]) if obj.get("event") is not None else None,
            "id": obj.get("id"),
            "ts": obj.get("ts")
        })
        return _obj
