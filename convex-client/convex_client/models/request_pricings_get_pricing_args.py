...
class RequestPricingsGetPricingArgs(BaseModel):
    """
    RequestPricingsGetPricingArgs
    """ # noqa: E501
    tier: RequestPricingsGetPricingArgsTier
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tier": RequestPricingsGetPricingArgsTier.from_dict(obj["tier"]) if obj.get("tier") is not None else None
        })
        return _obj
