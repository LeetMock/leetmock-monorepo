...
class ResponseAgentStatesGetBySessionId(BaseModel):
    """
    ...
    value: Optional[ResponseAgentStatesGetBySessionIdValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": ResponseAgentStatesGetBySessionIdValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
