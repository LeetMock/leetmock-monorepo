...
class RequestUserProfilesGetByEmailInternal(BaseModel):
    """
    RequestUserProfilesGetByEmailInternal
    """ # noqa: E501
    args: RequestUserProfilesGetByEmailInternalArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestUserProfilesGetByEmailInternalArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
