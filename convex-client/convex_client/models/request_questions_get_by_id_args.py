...
class RequestQuestionsGetByIdArgs(BaseModel):
    """
    RequestQuestionsGetByIdArgs
    """ # noqa: E501
    question_id: Optional[StrictStr] = Field(default=None, description="ID from table \"questions\"", alias="questionId")
    __properties: ClassVar[List[str]] = ["questionId"]
