...
class RequestPricingsGetPricingsInternal(BaseModel):
    """
    RequestPricingsGetPricingsInternal
    """ # noqa: E501
    args: RequestPricingsGetPricingArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestPricingsGetPricingArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
