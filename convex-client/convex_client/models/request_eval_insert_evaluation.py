...
class RequestEvalInsertEvaluation(BaseModel):
    """
    RequestEvalInsertEvaluation
    """ # noqa: E501
    args: RequestEvalInsertEvaluationArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestEvalInsertEvaluationArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
