...
class RequestFunctionsBackfillAggregatesMigrationArgs(BaseModel):
    """
    RequestFunctionsBackfillAggregatesMigrationArgs
    """ # noqa: E501
    batch_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="batchSize")
    cursor: Optional[StrictStr] = None
    dry_run: Optional[StrictBool] = Field(default=None, alias="dryRun")
    fn: Optional[StrictStr] = None
    next: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["batchSize", "cursor", "dryRun", "fn", "next"]
