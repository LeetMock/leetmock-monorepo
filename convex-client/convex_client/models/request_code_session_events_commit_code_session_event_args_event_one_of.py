...
class RequestCodeSessionEventsCommitCodeSessionEventArgsEventOneOf(BaseModel):
    """
    RequestCodeSessionEventsCommitCodeSessionEventArgsEventOneOf
    """ # noqa: E501
    data: RequestCodeSessionEventsCommitCodeSessionEventArgsEventOneOfData
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['content_changed']):
            raise ValueError("must be one of enum values ('content_changed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RequestCodeSessionEventsCommitCodeSessionEventArgsEventOneOfData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "type": obj.get("type")
        })
        return _obj
