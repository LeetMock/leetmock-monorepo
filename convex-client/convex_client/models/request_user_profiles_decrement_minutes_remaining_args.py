...
class RequestUserProfilesDecrementMinutesRemainingArgs(BaseModel):
    """
    RequestUserProfilesDecrementMinutesRemainingArgs
    """ # noqa: E501
    minutes: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["minutes"]
