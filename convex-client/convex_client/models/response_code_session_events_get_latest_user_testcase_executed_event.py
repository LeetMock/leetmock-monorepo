...
class ResponseCodeSessionEventsGetLatestUserTestcaseExecutedEvent(BaseModel):
    """
    ...
    value: Optional[ResponseCodeSessionEventsGetLatestUserTestcaseExecutedEventValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": ResponseCodeSessionEventsGetLatestUserTestcaseExecutedEventValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
