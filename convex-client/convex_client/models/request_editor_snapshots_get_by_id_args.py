...
class RequestEditorSnapshotsGetByIdArgs(BaseModel):
    """
    RequestEditorSnapshotsGetByIdArgs
    """ # noqa: E501
    snapshot_id: Optional[StrictStr] = Field(default=None, description="ID from table \"editorSnapshots\"", alias="snapshotId")
