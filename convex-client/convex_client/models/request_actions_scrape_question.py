...
class RequestActionsScrapeQuestion(BaseModel):
    """
    RequestActionsScrapeQuestion
    """ # noqa: E501
    args: RequestActionsScrapeQuestionArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestActionsScrapeQuestionArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
