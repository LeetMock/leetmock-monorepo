...
class ResponseActionsGenerateQuestionValue(BaseModel):
    """
    ResponseActionsGenerateQuestionValue
    """ # noqa: E501
    eval_mode: StrictStr = Field(alias="evalMode")
    function_name: StrictStr = Field(alias="functionName")
    input_parameters: Dict[str, Any] = Field(alias="inputParameters")
    tests: List[ResponseActionsGenerateQuestionValueTestsInner]
    __properties: ClassVar[List[str]] = ["evalMode", "functionName", "inputParameters", "tests"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evalMode": obj.get("evalMode"),
            "functionName": obj.get("functionName"),
            "inputParameters": obj.get("inputParameters"),
            "tests": [ResponseActionsGenerateQuestionValueTestsInner.from_dict(_item) for _item in obj["tests"]] if obj.get("tests") is not None else None
        })
        return _obj
