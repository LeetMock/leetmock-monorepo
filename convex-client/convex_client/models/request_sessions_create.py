...
class RequestSessionsCreate(BaseModel):
    """
    RequestSessionsCreate
    """ # noqa: E501
    args: RequestSessionsCreateArgs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": RequestSessionsCreateArgs.from_dict(obj["args"]) if obj.get("args") is not None else None
        })
        return _obj
