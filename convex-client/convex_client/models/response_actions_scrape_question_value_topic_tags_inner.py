...
class ResponseActionsScrapeQuestionValueTopicTagsInner(BaseModel):
    """
    ResponseActionsScrapeQuestionValueTopicTagsInner
    """ # noqa: E501
    name: StrictStr
    slug: StrictStr
    translated_name: Optional[StrictStr] = Field(alias="translatedName")
    __properties: ClassVar[List[str]] = ["name", "slug", "translatedName"]
