        ...
        <div id="blog">
            <Container>
                <div className="mb-12 space-y-2 text-center">
                    <h2 className="text-3xl font-bold text-gray-800 md:text-4xl dark:text-white">Latest Blogs</h2>
                    ...
                    {[
                        {
                            ...
                            description: "We've added a new feature to our platform that allows you to practice coding interviews with AI more efficiently."
                        },
                        {
                        ...
                        <div key={index} className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10 flex flex-col">
