...
export const tiers: PricingTier[] = [
    ...
    },
    {
        ...
        features: [
            ...
            `Extra 600 minutes (1200 minutes in total)`,
            `Customized voice options`,
            `More LLMs options`,
        ],
        featured: false,
        highlighted: true,
...
export default function PricingPage() {
    ...
    return (
        <div className={`relative ${urbanist.className}`}>
            ...
            <div className={cn('relative flex flex-col w-full items-center', styles.fancyOverlay)}>
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
                        <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
                            ...
                            <p className="text-black dark:text-white mt-6 md:text-xl lg:text-center max-w-prose">
                                Flexible, AI-powered interview practice plans to help you succeed at any stage of your journey.
                            </p>
                        </div>
