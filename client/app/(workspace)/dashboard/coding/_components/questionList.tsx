...
import { CheckCircle2, Circle, Eye, PlayCircle, Star } from "lucide-react";
...
export default function QuestionList({
  ...
  const isQuestionStarred = useCallback(
    (questionId: Id<"questions">) => {
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent side="top">
          <span className="text-xs">{completed ? "Completed" : "Mark as complete"}</span>
        </TooltipContent>
      </Tooltip>
    );
  };
  ...
  const StarButton = ({ questionId }: { questionId: Id<"questions"> }) => {
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent side="top">
          <span className="text-xs">{starred ? "Unstar question" : "Star question"}</span>
        </TooltipContent>
      </Tooltip>
    );
  };
        ...
        <div className="rounded-lg border shadow-sm">
          ...
          {questions.map((question, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-[200px]">
                <h3
                  className="text-sm font-medium text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors underline-offset-4 hover:underline truncate"
                  ...
                  <div className="prose dark:prose-invert max-w-none">
                    <div
                      dangerouslySetInnerHTML={{
                        __html: previewQuestion.question || "No description available.",
                      }}
                    />
                  </div>
                    ...
                    <div className="pt-4 border-t">
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {previewQuestion.tags.map((tag: string) => (
                          <span
                            key={tag}
                            className="px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs"
                          >
                            {tag}
                          </span>
                        ))}
