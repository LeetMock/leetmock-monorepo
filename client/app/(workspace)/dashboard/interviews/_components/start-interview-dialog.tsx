          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-6">
            <Card className="flex flex-col relative overflow-hidden">
              ...
              <CardContent className="flex-grow">
                <p>
                  Practice designing large-scale distributed systems with interactive diagrams and
                  AI assistance.
                </p>
              </CardContent>
              <CardFooter>
              ...
              <Badge
                variant="secondary"
                className="absolute top-2 right-2 bg-yellow-200 text-yellow-800"
              >
                Coming Soon
              </Badge>
            ...
            <Card className="flex flex-col">
              ...
              <CardContent className="flex-grow">
                <p>
                  Try our unique AI (not just a chatbot 🤖!) mock interview! It adapts in real-time,
                  giving you dynamic feedback, real interview pressure, and personalized
                  guidance—all while making it fun!
                </p>
              </CardContent>
              <CardFooter>
                <Button
            ...
            <Card className="flex flex-col relative overflow-hidden">
              ...
              <CardContent className="flex-grow">
                <p>
                  Enhance your communication and problem-solving skills with AI-powered behavioral
                  interviews.
                </p>
              </CardContent>
              <CardFooter>
