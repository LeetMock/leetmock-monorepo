      ...
      <Card className="max-w-2xl mx-auto p-8 bg-background">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-md">
            We&apos;re carefully evaluating your performance across multiple dimensions. This
            thoughtful analysis helps ensure you receive comprehensive and accurate feedback.
          </p>
        </motion.div>
      </Card>
    </div>
