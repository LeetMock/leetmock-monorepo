...
import { Clock, Brain, Code, Activity, CheckCircle2, XCircle } from "lucide-react";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
            ...
            <div className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-2xl font-bold">{statistics.interactionMetrics.clarifyingQuestions.count}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Quality Score</span>
                  <span className="text-2xl font-bold">{statistics.interactionMetrics.clarifyingQuestions.quality}/5</span>
                </div>
              </div>
              <div className="space-y-2">
                {statistics.interactionMetrics.clarifyingQuestions.examples.map((q: string, i: number) => (
                  <div key={i} className="text-sm text-muted-foreground">• {q}</div>
                ))}
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  <span>Questions Asked</span>
                  <span className="text-2xl font-bold">{statistics.interactionMetrics.followUpQuestions.totalAsked}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Correctly Answered</span>
                  <span className="text-2xl font-bold text-green-500">
                    {statistics.interactionMetrics.followUpQuestions.correctlyAnswered}/{statistics.interactionMetrics.followUpQuestions.totalAsked}
                  </span>
                </div>
              </div>
              <div className="space-y-2">
                {statistics.interactionMetrics.followUpQuestions.examples.map((q: any, i: number) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  <span>Coverage</span>
                  <span className="text-2xl font-bold">{statistics.codeMetrics.testCases.coverage}%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Pass Rate</span>
                  <span className="text-2xl font-bold text-green-500">
                    {statistics.codeMetrics.testCases.passed}/{statistics.codeMetrics.testCases.total}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 gap-4">
                <div className="p-4 bg-muted rounded-lg">
                  ...
                  <div className="text-2xl font-bold">{statistics.behavioralMetrics.stressHandling}/5</div>
                </div>
                <div className="p-4 bg-muted rounded-lg">
                  <div className="text-sm text-muted-foreground">Communication Clarity</div>
                  <div className="text-2xl font-bold">{statistics.behavioralMetrics.communicationClarity}/5</div>
                </div>
                <div className="p-4 bg-muted rounded-lg">
                  <div className="text-sm text-muted-foreground">Technical Articulation</div>
                  <div className="text-2xl font-bold">{statistics.behavioralMetrics.technicalArticulation}/5</div>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {Object.entries(statistics.behavioralMetrics.problemSolvingApproach).map(([key, value]) => (
