...

  {
    variants: {
      variant: {
        ...
        "outline-blue": "border border-blue-500 text-blue-500 hover:bg-blue-500/10",
        "outline-green": "border border-green-500 text-green-500 hover:bg-green-500/10",
        "outline-red": "border border-red-500 text-red-500 hover:bg-red-500/10",
        "outline-yellow": "border border-yellow-500 text-yellow-500 hover:bg-yellow-500/10",
        "outline-purple": "border border-purple-500 text-purple-500 hover:bg-purple-500/10",
        "outline-pink": "border border-pink-500 text-pink-500 hover:bg-pink-500/10",
      },
      size: {
